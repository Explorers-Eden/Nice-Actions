...
execute as @a[limit=1,scores={nice_actions.has_slept=1..}] unless score $sleep_triggered nice_actions.technical matches 1 run function nice_actions:calendar/player_slept
