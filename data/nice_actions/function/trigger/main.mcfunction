...
execute as @a[scores={nice_actions.dialog_trigger=1}] run function nice_actions:coords_hud/init with storage eden:settings nice_actions
execute as @a[scores={nice_actions.dialog_trigger=2}] run function nice_actions:time_hud/init with storage eden:settings nice_actions
