...
execute as @a[scores={nice_actions.stats_trigger=55..63}] run function nice_actions:share_stats/check_misc with storage eden:settings nice_actions
execute as @a[scores={nice_actions.stats_trigger=64..75}] run function nice_actions:share_stats/check_travel with storage eden:settings nice_actions
