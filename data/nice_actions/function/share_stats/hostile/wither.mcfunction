execute unless score @s nice_actions.stats.killed.wither matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.killed.wither"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Wither","italic":false,"translate":"entity.minecraft.wither"},\
