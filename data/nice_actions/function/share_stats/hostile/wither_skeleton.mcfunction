execute unless score @s nice_actions.stats.killed.wither_skeleton matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.killed.wither_skeleton"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Wither Skeleton","italic":false,"translate":"text.nice_actions.plural.wither_skeleton"},\
