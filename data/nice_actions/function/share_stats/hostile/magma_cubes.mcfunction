execute unless score @s nice_actions.stats.killed.magma_cubes matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.killed.magma_cubes"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Magma Cubes","italic":false,"translate":"text.nice_actions.plural.magma_cubes"},\
