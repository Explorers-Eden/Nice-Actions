execute unless score @s nice_actions.stats.killed.breeze matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.killed.breeze"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Breeze","italic":false,"translate":"text.nice_actions.plural.breeze"},\
