execute unless score @s nice_actions.days_lived.counter matches 1.. run return run tellraw @s [\
...
{"bold":false,"color":"white","text":" survived ","italic":false},\
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.days_lived.counter"}},\
{"text":" days without dying.","color":"white","bold":false,"italic":false}\
]\
