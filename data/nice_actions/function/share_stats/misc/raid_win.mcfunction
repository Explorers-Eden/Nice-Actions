execute unless score @s nice_actions.stats.misc.raid_win matches 1.. run return run tellraw @s [\
...
{"bold":false,"color":"white","text":" has won ","italic":false},\
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.misc.raid_win"}},\
