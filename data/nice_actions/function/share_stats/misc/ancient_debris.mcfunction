execute unless score @s nice_actions.stats.misc.animals_bred matches 1.. run return run tellraw @s [\
...
{"bold":false,"color":"white","text":" has bred ","italic":false},\
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.misc.animals_bred"}},\
{"text":" animals.","color":"white","bold":false,"italic":false}\
]\
