execute unless score @s nice_actions.stats.misc.fish_caught matches 1.. run return run tellraw @s [\
...
{"bold":false,"color":"white","text":" has caught ","italic":false},\
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.misc.fish_caught"}},\
{"text":" fish.","color":"white","bold":false,"italic":false}\
]\
