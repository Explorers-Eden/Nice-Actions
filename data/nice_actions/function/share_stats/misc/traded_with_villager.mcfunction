execute unless score @s nice_actions.stats.misc.traded_with_villager matches 1.. run return run tellraw @s [\
...
{"bold":false,"color":"white","text":" has traded ","italic":false},\
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.misc.traded_with_villager"}},\
{"text":" times with a villager.","color":"white","bold":false,"italic":false}\
]\
