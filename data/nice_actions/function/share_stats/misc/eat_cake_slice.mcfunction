execute unless score @s nice_actions.stats.misc.eat_cake_slice matches 1.. run return run tellraw @s [\
...
{"bold":false,"color":"white","text":" has eaten ","italic":false},\
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.misc.eat_cake_slice"}},\
{"text":" cake slices.","color":"white","bold":false,"italic":false}\
]\
