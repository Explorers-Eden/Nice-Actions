execute unless score @s nice_actions.stats.misc.sleep_in_bed matches 1.. run return run tellraw @s [\
...
{"bold":false,"color":"white","text":" has slept ","italic":false},\
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.misc.sleep_in_bed"}},\
{"text":" times.","color":"white","bold":false,"italic":false}\
]\
