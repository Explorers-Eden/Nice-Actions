execute unless score @s nice_actions.stats.travel.happy_ghast matches 1.. run return run tellraw @s [\
...
scoreboard players operation $temp_value_travel_stat nice_actions.technical = @s nice_actions.stats.travel.happy_ghast
...
{"text":" by Happy Ghast.","color":"white","bold":false,"italic":false}\
]\
