execute unless score @s nice_actions.stats.travel.minecart matches 1.. run return run tellraw @s [\
...
scoreboard players operation $temp_value_travel_stat eden.technical = @s nice_actions.stats.travel.minecart
...
{"text":" by Minecart.","color":"white","bold":false,"italic":false}\
]\
