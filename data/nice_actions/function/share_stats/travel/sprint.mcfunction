execute unless score @s nice_actions.stats.travel.sprint matches 1.. run return run tellraw @s [\
...
scoreboard players operation $temp_value_travel_stat nice_actions.technical = @s nice_actions.stats.travel.sprint
...
{"bold":false,"color":"white","text":" sprinted ","italic":false},\
