execute unless score @s nice_actions.stats.mined.crying_obsidian matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.mined.crying_obsidian"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Crying Obsidian","italic":false,"translate":"block.minecraft.crying_obsidian"},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
