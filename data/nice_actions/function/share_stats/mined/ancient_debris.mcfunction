execute unless score @s nice_actions.stats.mined.ancient_debris matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.mined.ancient_debris"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Ancient Debris","italic":false,"translate":"block.minecraft.ancient_debris"},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
