execute unless score @s nice_actions.stats.mined.deepslate_lapis_ore matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.mined.deepslate_lapis_ore"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Deepslate Lapis Lazuli Ore","italic":false,"translate":"block.minecraft.deepslate_lapis_ore"},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
