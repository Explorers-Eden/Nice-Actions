execute unless score @s nice_actions.stats.mined.nether_gold_ore matches 1.. run return run tellraw @s [\
...
{"bold":true,"color":"white","italic":false,"score":{"name":"@s","objective":"nice_actions.stats.mined.nether_gold_ore"}},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
{"bold":false,"color":"white","fallback":"Nether Gold Ore","italic":false,"translate":"block.minecraft.nether_gold_ore"},\
{"text":" ","color":"#89CFF0","bold":false,"italic":false},\
