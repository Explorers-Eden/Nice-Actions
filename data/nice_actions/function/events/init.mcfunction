...
execute if score $raw_daytime eden.technical matches 6000..6100 unless score $event_active eden.technical matches 1.. unless score $event_checked eden.technical matches 1.. run function nice_actions:events/start/init
...
execute unless score $raw_daytime eden.technical matches 6000..6100 run scoreboard players set $event_checked eden.technical 0