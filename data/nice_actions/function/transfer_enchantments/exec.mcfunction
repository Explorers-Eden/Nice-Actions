...
$execute unless items entity @s weapon.mainhand book run item modify entity @s weapon.mainhand {"type":"minecraft:set_components","components":{"minecraft:enchantments":$(enchantments)}}
...
advancement grant @s only eden:adventure/enchantment_exchange
